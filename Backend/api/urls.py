...
urlpatterns = [
    ...
    path('actualizar_rankin/', ActualizarRankingView.as_view(), name='actualizar_ranking'),
    path('listar_ranking/', ListarRankingView.as_view(), name='listar_ranking'),
